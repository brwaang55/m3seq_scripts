...
out_folder="/Genomics/adamsonlab/brucewang/data/${folder}_out22/"
out_file=="/Genomics/adamsonlab/brucewang/data/${folder}_out22/${folder}.bam"
...
java \
     ...
     DEFLATER_THREADS=4 \
     MATCHING_THREADS=4 \
     READ_STRUCTURE= 8M13B5S8B14S16M15S55T \
...
#     READ_STRUCTURE= 8M13B5S8B14S16M7S63T \
